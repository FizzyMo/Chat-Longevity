var fb = new Firebase("https://chat-doctors.firebaseio.com/");
...
usernameInput.on('keyup', function(e) {
  ...
  var location = new Firebase('https://chat-doctors.firebaseio.com/users/' + getTxt);
                                location.update({
...
$("#nope").click(function() {
    ...
    $('html, body').css('background', 'linear-gradient(135deg, rgba(54, 131, 252, 1) 0%,rgba(250, 252, 255, 1) 100%), url(' + svg + ')' + ', url(' + place_holder + ') fixed');
    ...
    var status = 'Online';
    $('.message').attr('placeholder', 'Hey ' + curUsername + '. . .');
!function(){var e={"buttons":[{"type":"call","token":"520-497-8298"}],"color":"#F0645A","position":"left","height":"45px","width":"45px","bottomSpacing":"850","callToActionMessage":"Call","displayOn":"desktop","lang":"en"},t=document.location.protocol+"//bothelp.io",o=document.createElement("script");o.type="text/javascript",o.async=!0,o.src=t+"/widget-folder/widget-page.js",o.onload=function(){new BhWidgetPage.init(e)};var n=document.getElementsByTagName("script")[0];n.parentNode.insertBefore(o,n)}();
    setTimeout(function() {
        $(".avatar_submit").click();
...
$("input.avatar_img").change(function() {
    ...
    setTimeout(function() {
        ...
        var svg = 'https://dl.dropboxusercontent.com/s/bnjpyba893qh6kg/pattern.svg';
        $('html, body').css('background', 'linear-gradient(135deg, rgba(205, 224, 254, 1) 0%,rgba(250, 252, 255, 1) 100%), url(' + svg + ')' + ', url(' + getImage + ') fixed');
        $('html, body').css('background-size', 'cover');
        var location_value = $("#setting_location").val();
        var image_location = new Firebase('https://glowing-heat-9106.firebaseio.com/users/' + curUsername);
